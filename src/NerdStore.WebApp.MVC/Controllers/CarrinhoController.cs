...
public class CarrinhoController : ControllerBase
{
    ...
    public async Task<IActionResult> IniciarPedido(CarrinhoDto carinhoDto)
    {
        var carrinho = await _pedidoQueries.ObterCarrinhoCliente(ClienteId);

        var command = new IniciarPedidoCommand(carrinho.PedidoId, ClienteId, carrinho.ValorTotal, carinhoDto.Pagamento.NomeCartao,
            carinhoDto.Pagamento.NumeroCartao, carinhoDto.Pagamento.ExpiracaoCartao, carinhoDto.Pagamento.CvvCartao);
